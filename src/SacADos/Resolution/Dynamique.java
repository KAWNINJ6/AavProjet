...
public class Dynamique extends Resolution {
    ...
    public void resoudre() {
        ...
        float[][] table = new float[nbItem][PoidsMax+1]; // matrice n(nombre d'objets) * n(poids maximal) des bénéfices
        ...
        // remonte le tableau, puis rajoute au sac les items avec le meilleur bénéfice
        int i = nbItem-1;
        int j = PoidsMax;
